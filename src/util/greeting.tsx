...
const morningShort = ['Fancy some breakfast?', 'What do you want to eat?', 'Have a good morning!'];
const afternoon = [
...
const getGreetings = () =>
    ...
    ({
        desktopGreeting: 'Want to win $40? Enter CMUEats raffle! (See footer for details)',

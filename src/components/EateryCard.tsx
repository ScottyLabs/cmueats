...
const Dot = styled(Card)(
  ({ state, changesSoon }: { state: LocationState; changesSoon: boolean }) => ({
      ...
      <Grid item xs={12} md={4} lg={3} xl={3}>
        <StyledCard>
          <StyledCardHeader
            title={
              isOpen ? (
                <OpenText variant="subtitle1" changesSoon={changesSoon}>
                  {statusMsg}
                </OpenText>
              ) : (
                <ClosedText variant="subtitle1" changesSoon={changesSoon}>
                  {statusMsg}
                </ClosedText>
              )
            }
            avatar={
              ...
              >
                <Dot state={location.locationState} changesSoon={changesSoon} />
              </Avatar>
            }
          />
          <CardContent>

				...
				<Link to="/rate-restaurant">
					...
					>
						<path
							strokeLinecap="round"
							strokeLinejoin="round"
							d="M12 8c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm0 2.25c-3.181 0-5.25 2.23-5.25
							5.25v.75h10.5v-.75c0-3.02-2.069-5.25-5.25-5.25z"
						/>
					</svg>
					Leave a Review
				</Link>
				<div
					className={`Navbar-active ${
						location.pathname === '/map'
							? 'Navbar-active_map'
							: location.pathname === '/rate-restaurant'
							? 'Navbar-active_review'
							: ''
					} Navbar-active_glow`}
				/>
			</div>
